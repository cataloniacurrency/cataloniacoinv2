...
void StatisticsPage::updateStatistics()
{
    ...
    QString phase = "";
    if (pindexBest->nHeight < 805000)
    {
        phase = "PoW-POS";
    }
    else if (pindexBest->nHeight > 805000)
    {
        phase = "PoW-POS";
    }
  ...
  /*  if(nSubsidy < rewardPrevious)
   ...
   /* if(pHardness > hardnessPrevious)
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " CATC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " CATC" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " CATC");
    }
