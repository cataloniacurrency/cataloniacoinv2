// Copyright (c) 2014 The Cataloniacoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("cataloniacoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("cataloniacoin-smsg-pow"); // Make this thread recognisable
